...
place le contour plus profondément dans la paroi que la récession.}
\label{fig:sim2-recession-contour-distance-fr}
\end{figure}

Les contours sont calculés par interpolation spatiale de l'enveloppe radiale
de \code{SVAR1}; aucune interpolation temporelle n'est ajoutée. Une ligne ne
commence que lorsque son seuil est effectivement atteint : aucun zéro
artificiel ne remplace les données absentes. Le contour à 90\,\% apparaît à
\SI{2}{s}, presque confondu avec la récession
\((\Delta d_{0.90}=\SI{0.0080}{mm})\), tandis que celui à 95\,\% se trouve
encore en amont \((\Delta d_{0.95}=\SI{-0.0439}{mm})\). Le contour à 99\,\%
n'est résolu qu'à partir de \SI{3}{s}. Au dernier état extrait,
\SI{6.15}{s}, les séparations atteignent respectivement
\SI{0.4263}{mm}, \SI{0.5543}{mm} et \SI{0.6294}{mm} pour les contours à
