...
$journal = "C:\ansys_sector_sim2\mesh_sector_mechanical.wbjn"
$process = Start-Process -FilePath $workbench -ArgumentList @("-B", "-F", $project, "-R", $journal) -PassThru -Wait
"ExitCode=$($process.ExitCode)" | Out-File -FilePath "C:\ansys_sector_sim2\mesh_sector_result.txt" -Encoding utf8
