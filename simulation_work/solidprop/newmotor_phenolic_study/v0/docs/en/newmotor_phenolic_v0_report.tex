...
The nominal step is \SI{0.025}{s}, reducible to \SI{0.0005}{s}; the reference
horizon is \SI{7}{s}. After each converged state the controller closes
\begin{equation}
 m_0=m_{\mathrm{solid}}+m_g+m_c+m_{\mathrm{ejected\ residue}}
\end{equation}
and audits energy using native element terms. A mass error above
\(10^{-6}m_0\), an energy error above 5\,\%, or a hot-load discrepancy above
2\,\% blocks the next solve.
