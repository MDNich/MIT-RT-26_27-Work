...
The September 21 refresh includes the virtual antenna pointer, mission coordinates, OpenRocket trajectory playback and repaired macOS dropdowns, alongside persistent Settings, the bundled v6.2 engine and Digital/Analog video. Current application results (101 passing tests and verified Mac packaging) are in `evidence/application-validation-virtual-pointer-2026-09-21.json`; the earlier files retain their historical results.
