...
\nolinkurl{evidence/application-validation-pointer-location-2026-09-21.json} & Current 101-test virtual-pointer validation and packaged Mac checks. Earlier evidence files retain their historical context. \\
\bottomrule
\end{longtable}
