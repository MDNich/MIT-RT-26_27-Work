...
The current antenna-location revision passed 107 Mac regression tests; the preceding virtual-pointer revision passed 101. Native Cocoa popup checks cover both themes and long device names. The previous Settings/engine revision passed 94 tests. Settings persistence, shortcut handling, bundled/custom simulations and local/latest/pinned build paths are covered. The earlier dual-video revision passed 77 tests. New checks
