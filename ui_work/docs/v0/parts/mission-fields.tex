...
\code{pointer_latitude} & 0.0 & Retained configuration field; not the current frozen legacy tracking origin. \\
\code{pointer_longitude} & 0.0 & Retained configuration field; not the current frozen legacy tracking origin. \\
\code{pointer_altitude} & 0.0 & Retained configuration field; legacy pointing uses ground height zero. \\
