...
\code{pointer_location_format} & latlon & Antenna entry: latlon, mgrs or relative; relative coordinates are recalculated during validation. \\
\code{pointer_location_code} & (empty) & MGRS entry provenance, up to 80 characters; canonical coordinates are authoritative for absolute entry. \\
\code{pointer_launch_heading} & 0.0 & True heading from antenna to rocket on its launch pad, 0 to 360 degrees. \\
\code{pointer_launch_distance} & 0.0 & Horizontal antenna-to-pad range in the antenna ENU frame, 0 to 100000 metres. \\
\code{pointer_height_difference} & 0.0 & Antenna minus launch ellipsoid altitude, metres; positive means antenna above launch site. \\
