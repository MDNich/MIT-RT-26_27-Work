...
"pointer_latitude":"Retained configuration field; not the current frozen legacy tracking origin.",
"pointer_longitude":"Retained configuration field; not the current frozen legacy tracking origin.",
"pointer_altitude":"Retained configuration field; legacy pointing uses ground height zero.",
