...
Current distribution & macOS arm64 app and DMG, rebuilt for virtual pointer rehearsal, dropdown sizing, Settings, OpenRocket-MIT v6.2, Digital/Analog video, flight save/load and URRG. Windows makefiles remain available; the Windows ZIP predates these changes. \\
Validation evidence & 101-test Mac regression run for virtual pointer, Settings, engine selection and dual video and packaged startup/demo/flight/OpenRocket verification. Historical September 20 results are retained separately. Physical dual-camera acceptance remains outstanding. \\
