...
\code{ui_work/rocket_UI_v0}, including Digital/Analog USB video, the portable flight-file workflow and
...
Current distribution & macOS arm64 app and DMG, rebuilt for Digital/Analog video, flight save/load and URRG. Windows makefiles remain available; the Windows ZIP predates these changes. \\
Validation evidence & 77-test Mac regression run for dual video, focused recording/replay checks and packaged startup/demo/flight/OpenRocket verification. Historical September 20 results are retained separately. Physical dual-camera acceptance remains outstanding. \\
